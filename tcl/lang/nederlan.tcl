...
menuText N EditFlip "Flip Board" 0 {Flip the board}
...
menuText N EditPasteBoard "Invoegen start stelling" 0 \
  {Cre�er een beginstelling van de huidige tekst selectie (van klembord)}
...
# ====== TODO To be translated ======
menuText N Analyse "Analyse" 0
# ====== TODO To be translated ======
menuText N AnalyseEngineList "Analysis Engines" 0 {Configure analysis engines}
# ====== TODO To be translated ======
menuText N AnalyseRating "Player Ratings" 0 {Graph the rating history of the current game players}
# ====== TODO To be translated ======
menuText N AnalyseScore "Score Graph" 0 {Show the score graph window}
# ====== TODO To be translated ======
menuText N AnalyseStartEngine1 "Start engine 1" 0  {Start engine 1}
# ====== TODO To be translated ======
menuText N AnalyseStartEngine2 "Start engine 2" 0  {Start engine 2}
# ====== TODO To be translated ======
menuText N AnalysePlayerReport "Player Report" 3 {Generate a player report}
# ====== TODO To be translated ======
menuText N AnalyseOpReport "Opening Report" 0 {Generate an opening report for the current position}
...
menuText N GInfoCoords "Co�rdinaten aan/uit" 0
...
translate N ChangeOrient {Wijzigen venster ori�ntatie}
...
menuText N TreeFileCopy "Kopieer boom tekst naar klembord" 0 \
  {Kopi�ren van de boomstatistieken naar het klembord}
...
translate N FinderCtxCopy {Kopi�ren}
...
translate N FinishGame {Be�indig partij}
...
Bijwerken cre�ert een nieuwe versie van de database. De originele bestanden blijven bestaan en worden niet gewijzigd.
...
translate N GrunfeldExchange {Gr�nfeld ruilvariant}
...
translate N KingsIndianSamisch {Koning-Indisch S�misch}
...
translate N CCDlgDuplicateGameError {Deze partij bestaat meer dan ��n keer in de database. Graag duplicaten verwijderen en partijenbestand comprimeren (Bestand/Onderhoud/Comprimeer database).}
